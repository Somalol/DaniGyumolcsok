...
function termekekBetoltes(){
    ...
    for(let termek of termekek){
        ...
        ul.classList = "list-group list-group-horizontal justify-content-center my-3";
        ...
        liMertekegyseg.innerHTML = termek.kiszereles+" "+termek.mertekegyseg;
...
function kosarMegjelen(){
  ...
  if(kosar == ""){
    ...
    for(let index of kosar){
      ...
      label.innerHTML = adottTermek.termek + " - " + adottTermek.ar + " Ft / " + adottTermek.kiszereles + " " + adottTermek.mertekegyseg;
...
document.getElementById("btnKosarMegtekint").addEventListener("click", kosarMegjelen);
