...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jún 25. 16:46
...
(4, 7, '2025-06-25', 'feldolgozas alatt');
...
INSERT INTO `termekek` (`id`, `nev`, `leiras`, `ar`, `mertekegyseg_id`, `kiszereles`) VALUES
(2, 'Burgonya', 'Ez egy sima krumpli', 120, 1, 1),
(3, 'Mars csoki', 'Eredeti házi mars csokika', 400, 3, 75),
(4, 'Tehén tej', 'Frissen facsart tehén tejecske', 500, 2, 5);
