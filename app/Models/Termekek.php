...
class Termekek extends Model
{
    ...
    {
        return DB::table("termekek")
            ->select("termekek.id", "termekek.nev as termek", "termekek.leiras", "termekek.ar", "termekek.kiszereles", "mertekegysegek.nev as mertekegyseg", "mertekegysegek.rovidites","termekek.kepURL", "termekek.kategoia_id", "kategoriak.kategoria")
